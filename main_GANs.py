...
Standard BCE is the default cost function, to change it to torch.nn.BCEWithLogitsLoss() the code needs to be changed
...
Label smoothing variation is implemented only for optimizer 'Jacobi'
